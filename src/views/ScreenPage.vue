...
export default {
  ...
  methods: {
    ...
    async init_getCountryData() {
      // const url = 'https://view.inews.qq.com/g2/getOnsInfo',
      //   params = { name: 'disease_h5' }
      // const res = await this.$jsonp(url, params)
      // const obj = JSON.parse(res.data)
      const obj = {
        nowConfirmStatis: { province: 505, gat: 2649016, import: 674 },
        provinceCompare: {
          新疆: { nowConfirm: 0, confirmAdd: 0, dead: 0, heal: 0, zero: 33 },
          台湾: {
            heal: 0,
            zero: 0,
            nowConfirm: 61953,
          ...
          广西: { zero: 0, nowConfirm: 1, confirmAdd: 1, dead: 0, heal: 0 },
          北京: { nowConfirm: -33, confirmAdd: 5, dead: 0, heal: 38, zero: 0 },
          江西: { zero: 31, nowConfirm: 0, confirmAdd: 0, dead: 0, heal: 0 },
          河南: { nowConfirm: -12, confirmAdd: 0, dead: 0, heal: 12, zero: 4 },
          浙江: { confirmAdd: 1, dead: 0, heal: 0, zero: 0, nowConfirm: 1 },
          澳门: { nowConfirm: 0, confirmAdd: 0, dead: 0, heal: 0, zero: 9 },
          西藏: { zero: 841, nowConfirm: 0, confirmAdd: 0, dead: 0, heal: 0 },
          上海: {
            zero: 0,
            nowConfirm: -170,
            confirmAdd: 4,
          ...
          云南: { heal: 0, zero: 1, nowConfirm: 0, confirmAdd: 0, dead: 0 },
          重庆: { nowConfirm: 0, confirmAdd: 0, dead: 0, heal: 0, zero: 3 },
          江苏: { nowConfirm: -1, confirmAdd: 0, dead: 0, heal: 1, zero: 8 },
          湖北: { nowConfirm: 0, confirmAdd: 0, dead: 0, heal: 0, zero: 8 },
          安徽: { heal: 0, zero: 40, nowConfirm: 0, confirmAdd: 0, dead: 0 },
          海南: { nowConfirm: 0, confirmAdd: 0, dead: 0, heal: 0, zero: 39 },
          湖南: { zero: 23, nowConfirm: 0, confirmAdd: 0, dead: 0, heal: 0 },
          香港: { zero: 0, nowConfirm: 27, confirmAdd: 56, dead: 4, heal: 25 },
          吉林: { nowConfirm: -1, confirmAdd: 0, dead: 0, heal: 1, zero: 6 },
          河北: { nowConfirm: 0, confirmAdd: 0, dead: 0, heal: 0, zero: 5 },
          福建: { nowConfirm: -7, confirmAdd: 2, dead: 0, heal: 9, zero: 0 },
          辽宁: { confirmAdd: 0, dead: 0, heal: 0, zero: 9, nowConfirm: 0 },
          内蒙古: { nowConfirm: 16, confirmAdd: 16, dead: 0, heal: 0, zero: 0 },
          天津: { heal: 0, zero: 0, nowConfirm: 1, confirmAdd: 1, dead: 0 },
          贵州: { dead: 0, heal: 0, zero: 20, nowConfirm: 0, confirmAdd: 0 },
          青海: { nowConfirm: 0, confirmAdd: 0, dead: 0, heal: 0, zero: 19 },
          黑龙江: { dead: 0, heal: 0, zero: 8, nowConfirm: 0, confirmAdd: 0 },
          山东: { confirmAdd: 0, dead: 0, heal: 0, zero: 1, nowConfirm: 0 },
          广东: { nowConfirm: -5, confirmAdd: 1, dead: 0, heal: 6, zero: 0 },
          山西: { nowConfirm: 0, confirmAdd: 0, dead: 0, heal: 0, zero: 2 },
          甘肃: { confirmAdd: 0, dead: 0, heal: 0, zero: 69, nowConfirm: 0 },
          陕西: { confirmAdd: 0, dead: 0, heal: 1, zero: 12, nowConfirm: -1 },
          四川: { confirmAdd: 0, dead: 0, heal: 6, zero: 1, nowConfirm: -6 },
          宁夏: { heal: 0, zero: 208, nowConfirm: 0, confirmAdd: 0, dead: 0 },
        },
      }

      this.allDataList = obj.provinceCompare.map((item) => ({
        name: item.name,
        value: item.confirmAdd,
      }))
      this.allNowDataList = obj.provinceCompare.map((item) => ({
        name: item.name,
        value: item.nowConfirm,
      }))
      this.allDeadList = obj.provinceCompare.map((item) => ({
        name: item.name,
        value: item.dead,
      }))
      this.allTodayCreadList = obj.provinceCompare.map((item) => ({
        name: item.name,
